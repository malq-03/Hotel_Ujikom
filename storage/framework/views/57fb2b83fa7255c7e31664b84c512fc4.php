                ...
                <?php $__currentLoopData = $room; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kamar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 col-sm-6">
                        <div id="serv_hover" class="room">
                            <div class="room_img">
                                <figure><img style="height: 200px; width:320px" src="../room/<?php echo e($kamar->gambar); ?>" alt=""/></figure>
                            </div>
                            <div class="bed_room">
                                <h3><?php echo e($kamar->nama_kamar); ?></h3>
                                <p><?php echo e(Str::limit($kamar->deskripsi, 100)); ?> </p>
                                <a class="btn btn-outline-info" href="<?php echo e(url('detail_kamar', $kamar->id)); ?>">Detail Kamar</a>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\hotel\resources\views/home/index.blade.php ENDPATH**/ ?>